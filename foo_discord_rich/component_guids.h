...
constexpr GUID conf_large_image_query = { 0xc0fb3da8, 0x3456, 0x41c2, { 0x86, 0x5c, 0x67, 0x40, 0xa4, 0x92, 0x3c, 0x9b } }; // +++
constexpr GUID conf_is_enabled = { 0x13ff3bbd, 0x1797, 0x42f1, { 0x96, 0xf4, 0x9d, 0xaf, 0x57, 0x31, 0x8d, 0xd2 } };
constexpr GUID conf_large_image_id_artwork = { 0x977818db, 0x26cc, 0x43d8, { 0x80, 0xdc, 0x90, 0x52, 0xdc, 0xa1, 0xfc, 0x55 } }; // +++
