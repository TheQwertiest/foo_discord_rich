...
set COMPONENT_NAME=foo_discord_rich
...
set COMPONENT_PDB_PACKAGE=%RESULT_CONFIGURATION_DIR%%COMPONENT_NAME%_pdb.zip
set FB2K_ARCHIVE=%RESULT_CONFIGURATION_DIR%%COMPONENT_NAME%.fb2k-component
